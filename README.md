...
![avatar](image/屏幕快照 2019-02-26 下午3.30.24.png)
...
```sql
     spqrk-sql
```
![avatar](image/屏幕快照 2019-02-26 下午3.54.15.png)
...
![avatar](image/屏幕快照 2019-02-26 下午5.31.19.png
)

* 总结：一共有23677条数据，其中Elevator特征有明显的缺失值。

![avatar](image/屏幕快照 2019-02-26 下午5.37.48.png)
...
```
![avatar](image/屏幕快照 2019-02-26 下午7.46.30.png)
...
![avatar](image/屏幕快照 2019-02-26 下午8.01.22.png)
...
```
结果对比：
![avatar](image/屏幕快照 2019-02-26 下午9.05.23.png)
...
![avatar](image/屏幕快照 2019-02-28 下午3.05.47.png)
...
```
按照size大小排序后，结果如下：
![avatar](image/屏幕快照 2019-02-28 下午3.27.04.png)

* 总结：对sql的数据类型有了更深的理解。

![avatar](image/屏幕快照 2019-02-28 下午3.30.13.png)
...
* 预处理：结合最开始的数据概览，知道了size的最大值为1019，以及对房屋面积大小概念的经验，可以先把size值大于500的先去掉，然后再进行归一化。
 ...
 ![avatar](image/屏幕快照 2019-02-28 下午3.46.20.png) 
 ...
 * 总结：观察Size与Price之间的散点图，发现Size特征基本与Price呈现线性关系，符合基本常识，面积越大，价格越高。但是有两组明显的异常点：1.面积不到是十平米，但是价格超出4000万。2.面积接近1000平方米，但是价格却很低。需要查看一下是什么情况。
 ...
 ```
  得到以下数据：
  ![avatar](image/屏幕快照 2019-02-28 下午6.14.21.png
)
...
```
 ...
 ![avatar](image/屏幕快照 2019-03-01 上午9.54.30.png)
...
对于Layout特征分析，可以统计不同户型的房子的数量。
 ...
 ![avatar](image/屏幕快照 2019-02-28 下午9.23.13.png)
 
![avatar](image/屏幕快照 2019-02-28 下午9.49.51.png
)
...
![avatar](image/屏幕快照 2019-02-28 下午10.11.14.png)
注：对2室1厅进行一下价格分析
...
![avatar](image/屏幕快照 2019-03-01 上午10.38.44.png)

* 发现Renovation装修特征中竟然有南北，它属于朝向特征，但是在柱状图上观察不到它的数量是多少，换饼状图看一下。
 
![avatar](image/屏幕快照 2019-03-01 上午10.42.31.png)
...
```
![avatar](image/屏幕快照 2019-03-01 上午11.02.41.png)
![avatar](image/屏幕快照 2019-03-01 上午11.05.30.png)
...
```
![avatar](image/屏幕快照 2019-03-01 上午11.12.54.png)
...
```
![avatar](image/屏幕快照 2019-03-01 下午12.26.39.png)
...
```
可视化结果：
![avatar](image/屏幕快照 2019-03-01 下午4.16.39.png)

分析：从图表中可以观察到，6层二手房的数量最多，有一个数量增长上的飞跃。

* 改进：可以对楼层的数量求和，这样可以看到楼层数量的增长趋势。

![avatar](image/屏幕快照 2019-03-01 下午4.22.57.png)
...
```
![avatar](image/屏幕快照 2019-03-01 下午8.41.40.png)
...
北京市各区域老破小TGI分布:
![avatar](image/屏幕快照 2019-03-01 下午10.21.16.png)
...
```
![avatar](image/屏幕快照 2019-03-01 下午10.56.52.png)

从上表中可以看出有很多脏数据，朝向名称混乱，还有平米数的错误数据，要把这些数据去掉。
![avatar](image/屏幕快照 2019-03-02 下午5.02.00.png)
...
select direction d, count(*) c from lj group by d order by c desc;
```
![avatar](image/屏幕快照 2019-03-02 下午6.40.36.png)
![avatar](image/屏幕快照 2019-03-02 下午6.41.10.png)

结合上面的图表数据画一个双y轴图：
![avatar](image/屏幕快照 2019-03-02 下午6.45.21.png
)
...
![avatar](image/屏幕快照 2019-03-02 下午6.11.57.png)
![avatar](image/屏幕快照 2019-03-02 下午7.06.15.png)
...
![avatar](image/屏幕快照 2019-03-02 下午7.58.01.png)
![avatar](image/屏幕快照 2019-03-02 下午8.01.29.png)
...
```
![avatar](image/屏幕快照 2019-03-02 下午8.09.33.png)
